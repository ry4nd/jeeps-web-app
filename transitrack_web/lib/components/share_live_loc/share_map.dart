...
import './share_mobile_route_info.dart';

// This is the main map

class ShareMapWidget extends StatefulWidget {
  ...
  @override
  State<ShareMapWidget> createState() => _ShareMapWidgetState();
}

class _ShareMapWidgetState extends State<ShareMapWidget>
  ...
  void didUpdateWidget(covariant ShareMapWidget oldWidget) {
  ...
  void updateJeeps() {
    ...
    if (toUpdate != null && toUpdate.isNotEmpty) {
      ...
      // Update or add the only jeep
      if (jeepEntities
          .any((e) => e.jeepAndDriver.jeep.device_id == jeep.jeep.device_id)) {
        int index = jeepEntities.indexWhere(
            (e) => e.jeepAndDriver.jeep.device_id == jeep.jeep.device_id);
        ...
        setState(() {
          selectedJeep = jeepEntities[index];
        });
      } else {
        _mapController
          ...
          iconImage: "jeepTopSelected", // Always use selected icon
          textField: "▬▬",
          ...
          textSize: jeep.driver != null ? 50 : 0,
            ...
            .then((symbol) {
          final newEntity = JeepEntity(jeepAndDriver: jeep, jeepSymbol: symbol);
          setState(() {
            jeepEntities.add(newEntity);
            selectedJeep = newEntity;
          });
        });
      }
    } else {
