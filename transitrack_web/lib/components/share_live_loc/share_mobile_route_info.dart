...
class ShareMobileRouteInfo extends StatefulWidget {
  ...
  @override
  State<ShareMobileRouteInfo> createState() => _ShareMobileRouteInfoState();
}

class _ShareMobileRouteInfoState extends State<ShareMobileRouteInfo> {
  ...
  @override
  void didUpdateWidget(covariant ShareMobileRouteInfo oldWidget) {
